        ...
        <div class="min-h-screen flex flex-col items-center justify-center">
            <div class="relative w-full max-w-7xl px-6">
                <header class="py-6 text-center">
                    <h1 class="text-3xl font-bold text-gray-700 dark:text-gray-200">Order and Transaction Management</h1>
                </header>
                ...
                <main class="mt-10 space-y-12">
                    ...
                    <!-- Transactions Table -->
                    <section class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
                        <h2 class="text-xl font-semibold mb-4 text-gray-800 dark:text-gray-200">Transactions Table</h2>
                        <div class="overflow-x-auto">
                            <table class="table-auto w-full border-collapse border border-gray-300 dark:border-gray-700">
                                <thead class="bg-gray-100 dark:bg-gray-700">
                                    <tr>
